...
@return le tas sous forme de string*)
...
let jouer_de : Personnage.Personnage.personnage -> int -> Personnage.Personnage.personnage = fun perso mise -> 
  if (Objet.Objet.qte_obj perso.sac Piece) = 0 then
    if mise <= (Objet.Objet.qte_obj perso.sac Piece) then
      ...
      let () = Affichage.Affichage.aff("\nVous ne possédez pas cette somme !\n") in perso
  else
...
@param perso : le personnage jouant au jeu
@return le nouvel etat du personnage avec son montant de pieces modifiés*)      
      ...
      if mise <= (Objet.Objet.qte_obj perso.sac Piece) then  
        let tas = generer_tas () in
          let rec aux : Personnage.Personnage.personnage -> int -> joueur -> int -> Personnage.Personnage.personnage = fun perso tas joueur mise ->
              ...
              if j = J1 then let () = Affichage.Affichage.aff("\n"^ligne_de_batons tas) in 
                  let () = Affichage.Affichage.aff(afficher_demander_qte_baton()) in
...
(** Type représentant type de pion
   @author Nicolas M*)
type pion = Croix | Rond | Vide

(** Type représentant une grille de morpion
    @author Nicolas M*)
type grille = G of pion*pion*pion * pion*pion*pion * pion*pion*pion

(** Type représentant les différents coups possibles
    @author Nicolas M*)
...
(** Fonctions pour changer le pion en A1 de la grille 
@author Nicolas M
...
(** Fonctions pour changer le pion en B1 de la grille 
@author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
...
(** Fonctions pour changer le pion en C1 de la grille 
@author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
...
(** Fonctions pour changer le pion en A2 de la grille
@author Nicolas M 
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
let setA2 : grille ->pion -> grille = fun (G (a1, b1, c1, _, b2, c2, a3, b3, c3)) -> function
    ...
    (** Fonctions pour changer le pion en B2 de la grille 
    @author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)
...
(** Fonctions pour changer le pion en C2 de la grille 
@author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
...
(** Fonctions pour changer le pion en A3 de la grille 
@author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
...
(** Fonctions pour changer le pion en B3 de la grille 
@author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
...
(** Fonctions pour changer le pion en C3 de la grille 
@author Nicolas M
@param grille la grille de la partie en cours
@param pion la position du pion dans la grille qu'on souhaite modfifier
@return la grille modifiée*)    
